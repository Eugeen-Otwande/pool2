        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-orange-600 dark:text-orange-400">Invite guests with supervision</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-orange-800 dark:text-orange-200">Resident Priority</h3>
