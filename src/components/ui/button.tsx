  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-white border border-white/20 hover:shadow-glass hover:scale-105 transform transition-spring shadow-glass backdrop-blur-glass",
        glass: "bg-white/10 text-white border border-white/20 backdrop-blur-glass hover:bg-white/20 shadow-glass",
        aquatic: "bg-gradient-student text-white hover:shadow-glass hover:scale-105 transform transition-spring",
      },
      size: {
